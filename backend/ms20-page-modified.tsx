// 复制到: frontend/src/app/[locale]/ai-equestrian-simulators/ms20-racehorse-jockey-training-simulator/page.tsx
'use client';
...
export default function MS20Page() {
  ...
  const productName = translation?.name || 'MS.20 Jockey Training Equestrian Simulator';
  const productTag = translation?.tag || '楠戝笀涓撻」璁绯?';
  const productDescription = translation?.description || '涓洪獞甯堜笌绔為€熻鍒掍€岀敓鐨?鏋侀€熸妯℃嫫';
  ...
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "keywords": "jockey training simulator, racehorse simulator, gallop simulator, speed equestrian simulator, horse racing simulator, equestrian simulator for exhibitions",
      ...
      <section style={{ position: 'relative', background: '#0A1E3F', minHeight: '600px' }}>
        ...
        <div id="ms20-hero-grid" style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'center' }}>
            ...
            `}</style>
            <img
              src={getProductImageUrl(product) || '/images/ms20.png'}
              alt={productName}
              style={{
                width: '100%',
                maxWidth: '480px',
      ...
      <section id="ms20-immersive-section" style={{ position: 'relative', height: '500px', overflow: 'hidden' }}>
        <img
          src="/images/ms20-immersive.jpg"
          alt="MS.20 jockey training simulator with immersive screen display"
          style={{
            width: '100%',
            height: '100%',
            objectFit: 'cover'
        ...
        <div style={{ position: 'absolute', bottom: 0, left: 0, padding: '60px 6%' }}>
          ...
          <p style={{
            ...
            涓撲为绔為€熻被璁绯冦佽禌椹綋楠岃璁捐锛屾皵鍘嬫劅搴旈┈闉嶏紝绮惧噯杩樺師楠戝笀濮跨姩锛屾敮鎸琚€冱€侀珮妯℃嫫锛岄厤澶瑰ぇ灞忋€佹蹈寮忓睍绀夌殑澶у睆銆?
          </p>
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
            {['琚€冱€侀珮妯℃嫫', '姘斿帀鎰熷簲', '楠戝笀璁绯?', '娌夋蹈澶у睆'].map((tag, index) => (
              <span
                key={index}
                style={{
                  padding: '6px 14px',
