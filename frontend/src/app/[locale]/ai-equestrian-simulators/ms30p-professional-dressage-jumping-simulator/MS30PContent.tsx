    ...
    <>
      ...
      <section className="ms30p-hero" style={{ position: 'relative', background: '#0A1E3F', minHeight: '600px' }}>
        ...
        <div id="ms30p-hero-grid" style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'center' }}>
            ...
            `}</style>
            <img
              src="/images/ms30p.png"
              alt="MS.30P Professional Equestrian Simulator - Dressage, Jumping and Eventing"
              style={{
                width: '100%',
                maxWidth: '480px',
                height: '420px',
      ...
      <section id="ms30p-immersive-section" style={{ position: 'relative', height: '500px', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', bottom: 0, left: 0, padding: '60px 6%' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
            {(t.raw('immersive.tags') as string[]).map((tag, index) => (
              <span
                key={index}
                style={{
                  padding: '6px 14px',
        ...
        <div className="ms30p-features-slider" id="ms30p-features-slider" style={{ position: 'relative', overflow: 'hidden' }}>
          ...
          >
            ...
            <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
              {(t.raw('features.card1.tags') as string[]).map((tag, index) => (
                <span
                  key={index}
                  style={{
                    fontSize: '11px',
          ...
          <div style={{
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              ...
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                {(t.raw('features.card2.tags') as string[]).map((tag, index) => (
                  <span
                    key={index}
                    style={{
                      padding: '4px 10px',
          ...
          >
            ...
            <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
              {(t.raw('features.card3.tags') as string[]).map((tag, index) => (
                <span
                  key={index}
                  style={{
                    fontSize: '11px',
      ...
      <section style={{ padding: '80px 0', background: '#F5F0E8', borderTop: '1px solid #E0D8C8', width: '100%', overflowX: 'hidden', boxSizing: 'border-box' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '0 60px' }}>
          ...
          <div id="ms30p-specs-left" style={{
            ...
            {(t.raw('specs.left') as string[][]).map(([label, value], index) => (
              <div
                key={index}
                style={{
                  display: 'flex',
          ...
          <div id="ms30p-specs-right" style={{
            ...
            {(t.raw('specs.right') as string[][]).map(([label, value], index) => (
              <div
                key={index}
                style={{
                  display: 'flex',
      ...
      <section style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '48px', marginTop: '36px', flexWrap: 'wrap' }}>
            ...
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: 'clamp(28px, 3vw, 42px)', fontWeight: 800, color: '#C9A84C' }}>200+</div>
              <div style={{ fontSize: '13px', color: '#5A6478', marginTop: '4px' }}>{t('whatIs.stat2')}</div>
            </div>
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: 'clamp(28px, 3vw, 42px)', fontWeight: 800, color: '#C9A84C' }}>HKJC</div>
      ...
      <div style={{ background: '#fff', padding: '40px 6%' }}>
        <div style={{ maxWidth: '960px', margin: '0 auto' }}>
          <div style={{ fontSize: '14px', fontWeight: 700, letterSpacing: '1.5px', textTransform: 'uppercase', color: '#C9A84C', textAlign: 'center', marginBottom: '8px' }}>{t('downloads.tag')}</div>
          <h2 style={{ fontSize: '24px', fontWeight: 800, color: '#0A1E3F', textAlign: 'center', marginBottom: '32px' }}>{t('downloads.title')}</h2>
          <div id="ms30p-downloads-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '20px' }}>
            <div style={{ background: '#fff', borderRadius: '12px', border: '1px solid #E0D8C8', padding: '24px', display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <a href="/downloads" style={{ display: 'inline-block', padding: '10px 18px', background: '#0A1E3F', color: '#fff', borderRadius: '8px', fontSize: '13px', fontWeight: 600, textDecoration: 'none', flexShrink: 0, whiteSpace: 'nowrap' }}>{t('downloads.item1.btn')}</a>
            </div>
            <div style={{ background: '#fff', borderRadius: '12px', border: '1px solid #E0D8C8', padding: '24px', display: 'flex', alignItems: 'center', gap: '16px' }}>
              <div style={{ fontSize: '36px', flexShrink: 0 }}>🏅</div>
              <div style={{ flex: 1 }}>
              ...
              <a href="/downloads" style={{ display: 'inline-block', padding: '10px 18px', background: '#0A1E3F', color: '#fff', borderRadius: '8px', fontSize: '13px', fontWeight: 600, textDecoration: 'none', flexShrink: 0, whiteSpace: 'nowrap' }}>{t('downloads.item2.btn')}</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <section style={{
        ...
        <div id="ms30p-cta-buttons" style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
          <a
            href="/contact"
            style={{
              padding: '14px 32px',
